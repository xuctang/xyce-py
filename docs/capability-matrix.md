...
| Schematic or XDM netlist import | Partial | `XdmTranslator`, `XdmTranslationResult`, `XdmTranslationError` | Unit tests with fake external XDM executable for success, failure, and missing outputs |
