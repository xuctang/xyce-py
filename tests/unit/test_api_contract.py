...
def test___all___exports_resolve_to_expected_objects():
    expected_objects = {
        ...
        "PrintDirective": directives.PrintDirective,
        "RawNTerminalDevice": models.RawNTerminalDevice,
        "RawDirective": directives.RawDirective,
        "RawTwoTerminalElement": models.RawTwoTerminalElement,
